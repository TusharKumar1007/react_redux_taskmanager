    ...
    return (
        <div className="w-full sm:w-3/5 lg:w-1/2 bg-[#2B2A2A] p-4 rounded text-center shadow-2xl">
            <form onSubmit={(e) => {
                ...
                <button className="text-xs md:text cursor-pointer transition-all ml-4 bg-red-600 text-slate-200 font-semibold p-2 rounded hover:translate-y-0.5 shadow-[2px_4px_5px_#2B2A2A] hover:shadow-[1px_2px_5px_#2B2A2A]">Delete Acount</button>
            </form>
        </div>
    )
}
